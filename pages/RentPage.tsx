    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md mb-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    <label htmlFor="price" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Monthly Rent</label>
...
const RentPage: React.FC = () => {
    ...
    const filteredProperties = useMemo(() => {
        ...
        return rentProperties.filter(property => {
            ...
            if (price && price !== 'any') {
                if (price === '0-30000' && property.price > 30000) return false;
                if (price === '30000-50000' && (property.price < 30000 || property.price > 50000)) return false;
                if (price === '50000+' && property.price < 50000) return false;
            }
            return true;
        });
    }, [properties, filters]);
        ...
        <div className="bg-gray-50 dark:bg-gray-900">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white">Properties for Rent</h1>
                    <p className="mt-3 text-lg text-gray-500 dark:text-gray-400">Find the perfect rental property to call home.</p>
                </div>
